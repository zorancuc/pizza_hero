    ...
    <div className="section what-is-pizza-heroes-section">
      <div className="what-is-pizza-heroes-container">
        ...
        <ContentItem
          ...
          image="https://storage.cloud.google.com/geometric-watch-246204.appspot.com/images/blockchain-icon_1blockchain-icon.png"
          content="Characters and items are NFT&#x27;s stored on the Tron blockchain as TRC721 tokens."
          align="left"
        />
        <ContentItem
          title="Video Games"
          image="https://storage.cloud.google.com/geometric-watch-246204.appspot.com/images/activities-icon_1activities-icon.png"
          content="Play with your character and adventure in an open world action RPG video game."
          align="right"
        />
        <ContentItem
          title="Rare Items &amp; Marketplace"
          image="https://storage.cloud.google.com/geometric-watch-246204.appspot.com/images/rare-items-icon_1rare-items-icon.png"
        ...
        <ContentItem
          ...
          image="https://storage.cloud.google.com/geometric-watch-246204.appspot.com/images/trx-icon_1trx-icon.png"
